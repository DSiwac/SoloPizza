  ...
  await queryInterface.bulkInsert("Pizzas", [
    {
      ...
      picture: "https://papitospizza.ru/wa-data/public/shop/products/27/00/27/images/272/272.970.jpg",
      createdAt: new Date(),
      updatedAt: new Date(),
    },
    {
      ...
      comp: "Состав: моцарелла, сальсичча, соус для пиццы, табаско, оливковое масло на травах",
       picture: "https://papitospizza.ru/wa-data/public/shop/products/41/00/41/images/268/268.970.jpg",
      createdAt: new Date(),
      updatedAt: new Date(),
    },
    {
      ...
      comp: "Состав: свиной окорок, моцарелла, соус бальзамико, сливочный соус",
       picture: "https://papitospizza.ru/wa-data/public/shop/products/20/00/20/images/303/303.970.jpg",
      createdAt: new Date(),
      updatedAt: new Date(),
    },
    {
      ...
      comp: "Состав: моцарелла, гауда, дор блю, пармезан, сливочный соус",
       picture: "https://papitospizza.ru/wa-data/public/shop/products/35/00/35/images/273/273.970.jpg",
      createdAt: new Date(),
      updatedAt: new Date(),
    },
  ]);
